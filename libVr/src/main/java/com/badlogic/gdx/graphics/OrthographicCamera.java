...
public class OrthographicCamera extends Camera {
    ...
    /**
     * Constructs a new OrthographicCamera, using the given viewport width and screenHeight. For pixel perfect 2D rendering just supply
     ...
     */
    public OrthographicCamera(int screenWidth, int screenHeight, float viewportWidth, float viewportHeight) {
        super(screenWidth, screenHeight);
    ...
    public void setToOrtho(boolean yDown) {
        setToOrtho(yDown, screenWidth, screenHeight);
    }
